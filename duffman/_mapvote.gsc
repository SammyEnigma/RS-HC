...
startMapvote()
{
	if(getentarray("player", "classname").size < 6 && getDvar("server_type") != "sd")
		setDvar( "sv_maprotation", "gametype dm map mp_crash gametype dm map mp_crossfire gametype war map mp_crash gametype war map mp_shipment gametype war map mp_killhouse gametype dm map mp_strike gametype dm map mp_shipment gametype dm map mp_killhouse" );
	else if(getDvar("server_type") != "sd")
		setDvar("sv_mapRotation" , "gametype sd map mp_crossfire gametype war map mp_crash gametype war map mp_killhouse gametype war map mp_crash gametype war map mp_bog gametype sab map mp_creek gametype war map mp_crossfire gametype war map mp_countdown gametype war map mp_vacant gametype sab map mp_convoy gametype sab map mp_crossfire gametype war map mp_broadcast gametype war map mp_crossfire gametype war map mp_backlot gametype war map mp_strike gametype sd map mp_pipeline gametype war map mp_creek gametype sd map mp_crash gametype sab map mp_strike gametype sd map mp_convoy gametype war map mp_pipeline gametype sd map mp_strike gametype sd map mp_backlot gametype war map mp_convoy gametype war map mp_cargoship gametype war map mp_showdown gametype sd map mp_showdown gametype war map mp_overgrown gametype war map mp_citystreets gametype sd map mp_citystreets gametype war map mp_carentan gametype sd map mp_carentan gametype war map mp_crash_snow gametype sd map mp_crash_snow");
	else 
